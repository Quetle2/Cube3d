...
/*   Updated: 2026/03/18 12:27:29 by jobraga-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cubed3d.h"

static void	color_fireball(t_game *game, t_vars vars, int i)
{
	if (game->theme == 0)
...
static void	draw_line_maismore(t_vars *vars, t_game *game)
{
	vars->hit = 0;
